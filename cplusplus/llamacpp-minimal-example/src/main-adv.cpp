/// TAKEN VERBATIM FROM https://github.com/ggml-org/llama.cpp/tree/master/examples/simple-chat
//// just to show how it sits in a simple CMake project
